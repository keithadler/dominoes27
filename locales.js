...
LOCALES.en = {
  ...
  ui: {
    ...
    missedScoringPlays: 'Missed Scoring Plays',
    noMovesYet: 'No moves yet',
    exportData: '📤 Export',
    importData: '📥 Import',
    dominoesDetail: 'dominoes!',
...
LOCALES.es = {
  ...
  ui: {
    ...
    missedScoringPlays: 'Jugadas de Puntos Perdidas',
    noMovesYet: 'Sin jugadas aún',
    exportData: '📤 Exportar',
    importData: '📥 Importar',
    dominoesDetail: '¡dominó!',
    rageQuitLossNote: 'Esto cuenta como derrota en tu historial.',
    rageQuitTaunts: [
      '¿En serio? ¿Te vas así? 🏃‍♂️\nLas fichas no muerden...',
      '¿Ya te rindes? Los oponentes se están riendo de ti. 😂',
      'Los ganadores nunca se rinden.\nLos que se rinden nunca ganan.\n¿Cuál eres tú? 🤔',
      '¿Seguro? Tus oponentes le contarán a TODOS. 📢',
      'El cementerio llamó. Dice que tiene más huesos que tú. 🦴',
      'Abandonar es perder con pasos extra. 💀',
      'Tu avatar está llorando. No le hagas esto. 😢',
      'Dato curioso: el 100% de los que abandonan se arrepienten.\nBueno, me lo inventé. Pero aún así. 📊',
      'Las fichas creen en ti aunque tú no creas en ti mismo. 🁣',
      'Giro de trama: estabas a punto de ganar. Probablemente. Quizás. 🎬',
...
LOCALES.ar = {
  ...
  ui: {
    ...
    missedScoringPlays: 'فرص تسجيل ضائعة',
    noMovesYet: 'لا توجد حركات بعد',
    exportData: '📤 تصدير',
    importData: '📥 استيراد',
    dominoesDetail: 'دومينو!',
    rageQuitLossNote: 'هذا يُحسب كخسارة في سجلك.',
    rageQuitTaunts: [
      'حقاً؟ ستمشي هكذا؟ 🏃‍♂️\nالقطع ليست مخيفة...',
      'تستسلم بالفعل؟ الخصوم يضحكون عليك الآن. 😂',
      'الفائزون لا يستسلمون.\nالمستسلمون لا يفوزون.\nأيهما أنت؟ 🤔',
      'متأكد؟ خصومك سيخبرون الجميع. 📢',
      'المقبرة اتصلت. قالت إنها أقوى منك. 🦴',
      'الانسحاب هو الخسارة بخطوات إضافية. 💀',
      'صورتك الرمزية تبكي الآن. لا تفعل هذا بها. 😢',
      'حقيقة: ١٠٠٪ من المنسحبين يندمون.\nحسناً اخترعت ذلك. لكن مع ذلك. 📊',
      'قطع الدومينو تؤمن بك حتى لو لم تؤمن بنفسك. 🁣',
      'تطور مفاجئ: كنت على وشك الفوز. ربما. 🎬',
...
LOCALES.zh = {
  ...
  ui: {
    ...
    aiPass: '我过。😤',
    rerollOpponent: '换对手',
    missedScoringPlays: '错过的得分机会',
    noMovesYet: '暂无操作',
    exportData: '📤 导出',
    importData: '📥 导入',
    dominoesDetail: '多米诺！',
    rageQuitLossNote: '这将计为一次失败。',
    rageQuitTaunts: [
      '真的？就这样走了？🏃‍♂️\n骨牌没那么可怕...',
      '已经放弃了？AI对手正在嘲笑你。😂',
      '赢家从不放弃。\n放弃的人永远不会赢。\n你是哪种？🤔',
